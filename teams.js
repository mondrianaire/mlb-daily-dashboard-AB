...
// brand-color references. Abbreviations are MLB.com's official 3-letter codes.

export const TEAM_META = {
  108: { abbr: "LAA", name: "Los Angeles Angels",       league: "AL", division: "West",    primaryColor: "#BA0021", secondaryColor: "#003263" },
  109: { abbr: "ARI", name: "Arizona Diamondbacks",     league: "NL", division: "West",    primaryColor: "#A71930", secondaryColor: "#000000" },
  110: { abbr: "BAL", name: "Baltimore Orioles",        league: "AL", division: "East",    primaryColor: "#DF4601", secondaryColor: "#000000" },
  111: { abbr: "BOS", name: "Boston Red Sox",           league: "AL", division: "East",    primaryColor: "#BD3039", secondaryColor: "#0C2340" },
  ...
  114: { abbr: "CLE", name: "Cleveland Guardians",      league: "AL", division: "Central", primaryColor: "#00385D", secondaryColor: "#E50022" },
  115: { abbr: "COL", name: "Colorado Rockies",         league: "NL", division: "West",    primaryColor: "#333366", secondaryColor: "#C4CED4" },
  116: { abbr: "DET", name: "Detroit Tigers",           league: "AL", division: "Central", primaryColor: "#0C2340", secondaryColor: "#FA4616" },
  ...
  147: { abbr: "NYY", name: "New York Yankees",         league: "AL", division: "East",    primaryColor: "#003087", secondaryColor: "#0C2340" },
